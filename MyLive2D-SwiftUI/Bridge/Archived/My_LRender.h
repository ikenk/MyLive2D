...
// 2. 声明我们的指定初始化方法
- (instancetype)initWithViewController:(UIViewController<MetalViewDelegate> *)viewController commandQueue:(id<MTLCommandQueue>)commandQueue depthTexture:(id<MTLTexture>)depthTexture NS_DESIGNATED_INITIALIZER;
