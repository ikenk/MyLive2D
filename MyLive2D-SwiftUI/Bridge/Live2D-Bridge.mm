...
- (void)setTexture:(csmUint32)textureNo to:(id<MTLTexture>)texture {
    _userModel->GetRenderer<Rendering::CubismRenderer_Metal>()->BindTexture(textureNo, texture);
}
